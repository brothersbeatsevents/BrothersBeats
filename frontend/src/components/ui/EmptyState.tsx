export default function EmptyState({
  ...
  return (
    <div className="text-center py-16 px-4">
      <div className="mx-auto w-14 h-14 rounded-full bg-bb-neutral flex items-center justify-center mb-4">
        <svg className="w-7 h-7 text-bb-text-muted" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path
            strokeLinecap="round"
